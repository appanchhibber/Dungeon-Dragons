...
/**
 * This controller is responsible for handling and listening to the events being
 * generated by the Campaign View
 * 
...
public class CampaignViewController implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == campaignView.addMap) {
			DefaultListModel model = (DefaultListModel) campaignView.campMaps
					.getModel();
			for (Object selectedValue : campaignView.maps
			...
			String mode = "edit";
			gameController.mainFrame.setView(new CampaignView(campaignModel,
					mode));
		}

		else if (e.getSource() == campaignView.removeMap) {
			DefaultListModel model = (DefaultListModel) campaignView.maps
					.getModel();
			campaignModel.campMapList = (DefaultListModel) campaignView.campMaps
					.getModel();
			for (Object selectedValue : campaignView.campMaps
					.getSelectedValuesList()) {
				model.addElement(selectedValue);
			...
			DefaultListModel list = (DefaultListModel) campaignView.campMaps
					.getModel();
			if (campaignView.nameText.getText().equals("")) {
				...
				File file = new File("campaign/"
						+ campaignView.nameText.getText() + ".xml");
	...
	/**
	 * This method is repsonsible for the creation of Dialog box for the user to
