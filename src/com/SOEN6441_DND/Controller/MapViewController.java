	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == mapView.inventView.validateButton) {
			...
			if (mapView.inventView.addCharacter.isSelected() == true) {
				mapModel.setCharacterList(ioModel
						.getAllFolderFile("characters"));
			} else {
			...
			ioModel.readCharaterFile(ioModel
					.setCharacterFile(mapView.inventView.characterDropDown
